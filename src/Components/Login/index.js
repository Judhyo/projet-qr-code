...
import Logo from "../../../src/images/avatar.jpeg";
import "./Login.css";
...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    //     "http://localhost:3001/login/responsable",
    //     user
    //   );
        ...
        <div className="login">
          ...
          <form autoComplete="Off" onSubmit={handleSubmit}>
            ...
            <div className="input-container">
              ...
              {/* {showEye ? (
                <FaEyeSlash className="icon-eye" onClick={handleClickIconEye} />
              ) : (
                <FaEye className="icon-eye" onClick={handleClickIconEye} />
              )} */}
            </div>
            <button
              ...
              type="submit"
            >
              <span className="icon-btn"></span> Se connecter
            </button>
          </form>
        </div>
      </div>
